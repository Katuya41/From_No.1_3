...
// 			EXPECT_EQ(0, list.GetCount());
		...
		*//***********************************************************************************/
		TEST(FrontConstIteratorTest, TestConstIteratorCheckToEmpty)
		{
			...
			EXPECT_EQ(true, Constit.CheckDammy());
		}
		...
		*//***********************************************************************************/
		...
		{
			LinkedList<DATA> list;
			LinkedList<DATA>::Iterator* it = new LinkedList<DATA>::Iterator();
			LinkedList<DATA>::Iterator* it2 = new LinkedList<DATA>::Iterator();
			list.InsertFront({10, "Test"});
			list.InsertLast({20, "Test"});
			LinkedList<DATA>::ConstIterator Constit = list.GetConstEnd();
			EXPECT_EQ(Constit, list.GetConstEnd());
